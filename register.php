    ...
    <div class="row">
        <div class="col-12 bg-clip-content text-black text-center">
            <header>
                <hgroup>
                    <h1>Registrácia</h1>
                    <h2>Vytvorenie nového konta použivateľa</h2>
                </hgroup>
            </header>
        </div>
    </div>
            ...
            <div class="col-12 bg-clip-content text-black text-center">
                <div class="container-md">
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        <label for="firstname">
                            Meno:
                            <input type="text" name="firstname" value="" id="firstname" placeholder="napr. Jonatan" maxlength="32" required>
                        </label>

                        <label for="lastname">
                            Priezvisko:
                            <input type="text" name="lastname" value="" id="lastname" placeholder="napr. Petrzlen" maxlength="32" required>
                        </label>
                        ...
                        <label for="email">
                            E-mail:
                            <input type="email" name="email" value="" id="email" placeholder="napr. jpetrzlen@example.com" maxlength="32" required>
                        </label>

                        <label for="login">
                            Login:
                            <input type="text" name="login" value="" id="login" placeholder="napr. jperasin" maxlength="32" required>
                        </label>
                        ...
                        if (isset($qrcode)) {
                            ...
                            echo $message;
                            echo '<p>Teraz sa možte prihlásiť: <a href="login.php" role="button">Login</a></p>';
                        }
                        ?>
